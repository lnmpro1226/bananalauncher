...
local seekGun = game:GetObjects("rbxassetid://126085169")[1] or LoadCustomInstance("https://raw.githubusercontent.com/persopoiu/scripts/main/SeekGunAssets/SeekPistol.rbxm")
...
local seekPuddle = game:GetObjects("rbxassetid://36064086")[1]
                ...
                if model ~= nil and not (workspace.CurrentRooms:FindFirstChild(model.Name)) and model ~= workspace then
                    ...
                    for _,instance in ipairs(model:GetDescendants()) do
                        if instance:IsA("BasePart") or instance:IsA("Part") or instance:IsA("MeshPart") then
                            ...
                            instance.Color = Color3.fromRGB(100,100,0)
                        end
